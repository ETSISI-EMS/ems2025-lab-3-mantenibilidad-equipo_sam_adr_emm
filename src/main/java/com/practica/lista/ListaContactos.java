...
public class ListaContactos {
	...
	public void insertarNodoTemporal (PosicionPersona p) {
		 ...
		 */
		if(!encontrado) {
			anadirNodo(p, ant, aux);
		}
	}

	private static void insertarCoordenadas(PosicionPersona p, NodoTemporal aux) {
	...
	private void anadirNodo(PosicionPersona p, NodoTemporal ant, NodoTemporal aux) {
